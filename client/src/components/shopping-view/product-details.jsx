...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogClose}>
      <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] p-0 sm:max-w-[70vw] lg:max-w-[70vw] h-screen">
        ...
        <ScrollArea >
          ...
          <div className="flex gap-2 flex-wrap">
            {[38, 39, 40, 41, 42, 43, 44, 45].map((size) => (
              <Button
                key={size}
                variant={selectedSize === size ? "default" : "outline"} // Highlight selected size
              ...
              <Button
                ...
                onClick={() => {
                  if (!selectedSize) {
                    toast({
                      description:
                        "Please choose a size before adding the product to your cart.",
                      variant: "destructive",
                    });
